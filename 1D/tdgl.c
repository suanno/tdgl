...
int N;
double dx, dt, Deltat, tmin, tmax;
//C(t) = Cave + Ampl*sin(2pi*t) unless it is required to read C(t) from a file "varfile.dat"
...
double* kink_dist = malloc(num_saves*sizeof(double)); double xk,x1,x2,u1,u2;
double weight_sum = 0;
int found_kink = 0;
...
varfile = fopen("tdgl_result.dat", "w");
